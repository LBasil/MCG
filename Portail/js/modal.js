...
!function () {
    function a(t) {
        t.style.display = "block", setTimeout(function () {
            t.classList.add("active"), document.body.classList.add("modalIG-active")
        }, e)
    } function i(t) {
        t.classList.remove("active"), setTimeout(function () {
            t.style.display = "none", document.body.classList.remove("modalIG-active")
        }, e)
    } function c(t, e) {
        if (e(t)) return t;
        for (; t && t.parentNode !== document;)
    ...
    var e = 250;
    document.addEventListener("keyup", function (t) {
        27 === t.keyCode && [].slice.call(document.querySelectorAll(".modalIG.active")).forEach(function (t) {
            i(t)
        })
    }), document.addEventListener("click", function (t) {
        var e = t.target;
        if (e.classList.contains("modalIG"))
            return i(e);
        if (e.classList.contains("modalIG-close"))
            return i(c(e, function (t) {
                return t.classList.contains("modalIG")
            }));
        var o = c(e, function (t) {
            if (t) return t.hasAttribute("data-toggle") && "modalIG" === t.getAttribute("data-toggle")
        });
        if (o) {
            var n = o.getAttribute("data-target");
            a(document.querySelector(n))
        ...
        "function" != typeof window.modalIG && (window.modalIG = function (t) {
            "string" == typeof t && (t = document.querySelector(t)), t ? t.classList.contains("active") ? i(t) : a(t) : console.error("Modal target not found!")
        })
}();
